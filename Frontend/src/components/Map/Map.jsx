...
const Map = () => {
  ...
  const { data: rainfall, isFetching:fetchingRainfall } = useGetRainfallMarkersQuery();
  ...
  return isLoaded ? (
    ...
    >
      ...
      {!isFetching && marks.features.map((mark, index) => {
        ...
        if (mark.properties.atrisk === true && mark.properties.type === type) {
        ...
        } else if (mark.properties.atrisk === false && mark.properties.type === type) {
          ...
          {!fetchingRainfall && rainfall?.features.map((mark,index) => {
            ...
            if(mark.properties.day_total > 0){
              ...
              return(
                ...
                onClick={() => {
                  setLocationInfoRainfall({name, unit, oneHourTotal, sixHourTotal, dayTotal, date})
                  }
                  }
    ...
    {locationInfoRainfall && <LocationInfoBoxRainfall info={locationInfoRainfall} />}
    </div>
